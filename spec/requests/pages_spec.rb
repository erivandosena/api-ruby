...
RSpec.describe "/pages", type: :request do
  ...
  # PagesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get pages_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Page" do
        expect {
          post pages_url,
               params: { page: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      ...
      it "renders a JSON response with errors for the new page" do
        post pages_url,
             params: { page: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested page" do
        page = Page.create! valid_attributes
        patch page_url(page),
              params: { page: new_attributes }, headers: valid_headers, as: :json
        page.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested page" do
      page = Page.create! valid_attributes
      expect {
        delete page_url(page), headers: valid_headers, as: :json
      }.to change(Page, :count).by(-1)
    end
  end
end
